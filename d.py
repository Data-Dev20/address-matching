...
# --- AGENT ASSIGNMENT ---
def assign_agents(df, agent_count, rolls_per_agent=200, min_weight=15, max_weight=25):
    df_sorted = df.copy()
...
if uploaded_file:
    ...
    if st.button("Start Processing"):
        ...
        df['Weight'] = pd.to_numeric(df.get('Weight', df['Roll Qty'] * 46 / 1000), errors='coerce').fillna(0)
